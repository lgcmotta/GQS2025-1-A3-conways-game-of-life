...
public class FinalGenerationTests
{
    ...
    public async Task
        FinalGeneration_WhenBoardIdIsNullOrEmptyOrMaxAttemptsIsNegativeOrZero_ShouldThrowValidationFailedException(
            string? boardId, int maxAttempts)
    {
        using var scope = _factory.Services.CreateScope();
    ...
    [Fact]
    public async Task
        FinalGeneration_WhenBoardExistsButCantReachStableGenerationAfterAttempts_ShouldThrowUnstableBoardException()
    {
        // Arrange
    ...
    [Fact]
    public async Task
        FinalGeneration_WhenBoardExistsAndStableStateIsWithinMaxAttempts_ShouldReturnFinalGenerationForBoard()
    {
        // Arrange
    ...
    [Fact]
    public async Task
        FinalGeneration_WhenRequestingUsingAPIWithinReachableMaxAttempts_ShouldRespondWithFinalStableGeneration()
    {
        // Arrange
        const int maxAttempts = 5;
    ...
    [Fact]
    public async Task
        FinalGeneration_WhenMaxAttemptsIsNotProvidedWithQueryString_ShouldUseFallbackValueFromConfiguration()
    {
        // Arrange
        var firstGeneration = new[,]
        {
    ...
    [Fact]
    public async Task
        FinalGeneration_WhenRequestingUsingAPIWithStableStateOutOfMaxAttemptsReach_ShouldRespondWithUnprocessableEntity()
    {
        // Arrange
        const int maxAttempts = 2;
